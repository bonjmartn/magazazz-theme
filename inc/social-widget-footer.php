...
class social_widget_footer extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Social Icons Footer', 'magazazz' ), // Name
      array( 'description' => __( 'Social Icons for the Footer', 'magazazz' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Follow Us', 'magazazz' );
    $facebook = ! empty( $instance['facebook'] ) ? $instance['facebook'] : __( '', 'magazazz' );
    $twitter = ! empty( $instance['twitter'] ) ? $instance['twitter'] : __( '', 'magazazz' );
    $pinterest = ! empty( $instance['pinterest'] ) ? $instance['pinterest'] : __( '', 'magazazz' );
    $instagram = ! empty( $instance['instagram'] ) ? $instance['instagram'] : __( '', 'magazazz' );
    $googleplus = ! empty( $instance['googleplus'] ) ? $instance['googleplus'] : __( '', 'magazazz' );
    $tumblr = ! empty( $instance['tumblr'] ) ? $instance['tumblr'] : __( '', 'magazazz' );
    $youtube = ! empty( $instance['youtube'] ) ? $instance['youtube'] : __( '', 'magazazz' );
    $linkedin = ! empty( $instance['linkedin'] ) ? $instance['linkedin'] : __( '', 'magazazz' );
    ?>


    <p>
    <label for="<?php echo $this->get_field_id('facebook_field'); ?>"><?php _e('Enter the URL for your Facebook page', 'magazazz'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('twitter_field'); ?>"><?php _e('Enter the URL for your Twitter profile', 'magazazz'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('pinterest_field'); ?>"><?php _e('Enter the URL for your Pinterest page', 'magazazz'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('instagram_field'); ?>"><?php _e('Enter the URL for your Instagram profile', 'magazazz'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('googleplus_field'); ?>"><?php _e('Enter the URL for your Google Plus profile', 'magazazz'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('tumblr_field'); ?>"><?php _e('Enter the URL for your Tumblr page', 'magazazz'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('youtube_field'); ?>"><?php _e('Enter the URL for your YouTube page', 'magazazz'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('linkedin_field'); ?>"><?php _e('Enter the URL for your LinkedIn profile', 'magazazz'); ?></label>
